  ...
  <div class="hero_area">
    ...
    <section class="why_section layout_padding">
      <div class="container">
        <div class="heading_container heading_center">
          <h2>
            Hal yang terjamin ketika belanja dengan Grosirku
          </h2>
        </div>
        <div class="row">
          <div class="col-md-4">
            <div class="box ">
              ...
              <div class="detail-box">
                ...
                <p>
                  Dalam kurang lebih 12 jam pesanan anda sudah pasti sampai!
                </p>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="box ">
              ...
              <div class="detail-box">
                ...
                <p>
                  Dalam radius 20km semua orderan kalian gratis :D
                </p>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="box ">
              ...
              <div class="detail-box">
                ...
                <p>
                  Semua produk yang sampai di anda adalah produk terbaik pilihan Grosirku
                </p>
              </div>
            </div>
          </div>
      ...
      <div class="container">
        <div class="heading_container heading_center">
          <h5>Grosirku adalah pilihan utama untuk kebutuhan grosir Anda karena kami menyediakan berbagai macam produk
            berkualitas tinggi dari berbagai kategori dengan harga yang kompetitif. Kami bangga memberikan layanan
            pelanggan yang ramah dan responsif, serta proses pembelian yang mudah dan pengiriman yang dapat diandalkan.
            Dengan Grosirku, Anda dapat mengandalkan pengalaman berbelanja yang menyenangkan dan efisien untuk memenuhi
            kebutuhan bisnis Anda.</h5>
        </div>
    </section>
